...
describe('assignment-test', function() {
    ...
    describe('List page', function () {
        ...
        it('should disable add button when form is not complete', async function() {
        ...
        it('should add new user to the end of table when complete fields and click button add', async function() {
      ...
      it('should not able create duplicate user', async function () {
        const uniqueUser = 'satang'
